package com.ohmz.tictactoe.confetti.view
...
import com.ohmz.fitnessTracker.confetti.design.Party
import com.ohmz.fitnessTracker.confetti.design.PartySystem
import com.ohmz.fitnessTracker.confetti.design.models.CoreRectImpl
...
import com.ohmz.fitnessTracker.confetti.view.image.ImageStore
import com.ohmz.fitnessTracker.confetti.view.image.draw
        ...
        party.shapes.map { shape ->
            when (shape) {
                is Shape.DrawableShape -> {
                    val referenceImage =
                        drawableToReferenceImage(shape.image as DrawableImage, imageStore)
